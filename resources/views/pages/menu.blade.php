...
@section('content')
                                ...
                                <div class="col-md-4">
                                    <div class="menu-wrap ftco-animate">
                                        <div class="menu-img img"
                                            style="background-image: url({{ url('public/images/' . $product->src) }});"></div>
                                ...
                                <div class="col-md-4 mb-3 product-item" data-id="{{ $product['id'] }}"
                                    ...
                                    <div class="card p-3">
                                        ...
                                        <input type="number" name="products[{{ $product['id'] }}][quantity]"
                                            class="form-control quantity-input" value="{{ $product['quantity'] }}"
                                            min="1">
                ...
                <div class="col-md-8 p-4 p-md-5 d-flex align-items-center justify-content-center bg-gray">
                    <form method="post" action="{{ route('order.store') }}" class="appointment-form" id="order-form">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="form-group">
                                    <input type="text" name="location" class="form-control form-control-lg"
                                        placeholder="Location" required value="{{ old('location') }}">
                                    @error('location')
                                        <small class="text-danger">{{ $message }}</small>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="form-group">
                                    <input type="datetime-local" name="order_arrival_time"
                                        class="form-control form-control-lg" required
                                        value="{{ old('order_arrival_time') }}">
                                    @error('order_arrival_time')
                                        <small class="text-danger">{{ $message }}</small>
                                    @enderror
                                </div>
                            </div>
                            ...
                            <div class="col-12 text-center mt-4">
                                <button type="submit"
                                    class="btn btn-light btn-lg py-3 px-5 rounded-pill font-weight-bold">
    ...
    <script>
        ...
        function scrollToOrder() {
            document.getElementById('order-display').scrollIntoView({
                behavior: 'smooth'
            });
        }
    ...
    <style>
        .fixed-order-button {
            ...
            left: 10px;
            width: 18%;
            background-color: rgba(248, 248, 248, 0.397);
            ...
            box-shadow: 0 -2px 10px rgba(187, 8, 8, 0);
            /* Red glow shadow */
        ...
        .fixed-order-button:hover {
            ...
            /* Darker and more transparent on hover */
            box-shadow: 0 -2px 40px rgba(255, 0, 0, 0.8);
